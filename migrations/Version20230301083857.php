 ...
 */
final class Version20230301083857 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE badge ADD badge_category VARCHAR(50) NOT NULL, ADD threshold INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE badge DROP badge_category, DROP threshold');
    }
}
